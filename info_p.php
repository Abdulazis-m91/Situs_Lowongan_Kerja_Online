...
$id=$_GET['id'];
$share1 = mysql_query("SELECT * from perusahaan where idprusahaan='$id'");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <?php if ($ada['id_login']==$na['id_login']) {
               # code...?> 
            <li class="nav-item ">
		...
		<div class="row">
          ...
          <!--  -->
            ...
            <?php } 
              ...
              <li class="nav-item text-center">
                <a class="nav-link login-button" href="admin_lowongan_perusahaan.php?id=<?php echo $ada1['idprusahaan']; ?>">Lihat Lowongan Perusahaan</a>
              </li> 
            <?php }?>
						</ul>
					</div>
