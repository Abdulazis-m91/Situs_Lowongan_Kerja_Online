 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
       <a href="index.php">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation" href="index.php">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="contact-us-content p-4">
                    ...
                    <h1 class="pt-3">Silahkan Lakukan Login</h1>
                    <p class="pt-3 pb-5">
                    	Jika terjadi kendala dalam melakukan Login anda dapat meminta bantuan dan menghubungi admin.<br>
                    Kamu belum memiliki akun ?! <a href="form_daftar.php" onClick="">Daftar Disini Gratis </a>
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                   <form class="form-signin" method="POST" action="login.php">
                        <fieldset class="p-4">
                            ...
                            <hr>
                               <p class="pt-0 pb-5">
                            Lupa password? <a href="forget_password.php" onClick="">Klik disini.</a></p>
