			...
			<div class="col-sm-6 col-md-4 col-md-offset-4">
				<div class="panel panel-default">
					...
					<div class="panel-body">
                        <form class="form-signin" method="POST" action="simpan_login_warga.php">
							<fieldset>
								<div class="row">
						...
						<input class="form-control" placeholder="Alamat Email" id="email" name="email" type="text" autofocus>                  
											</div>
										</div>
						...
						<input type="password" class="form-control" placeholder="Password" id="password" name="password" value="">
                                       ...
                                       <div class="form-group">
											...
											<input type="hidden" class="form-control" placeholder="Warga"   name="akses" readonly="" value="warga">
                                                </div>
                                               </div>
                                        ...
                                        <div class="form-group">
											<input type="submit" class="btn btn-lg btn-primary btn-block" value="DAFTAR">
										</div>
									</div>
								</div>
							</fieldset>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="contact-us-content p-4">
                    ...
                    <h1 class="pt-3">Mencari Pekerjaan</h1>
                    <p class="pt-3 pb-5">
                      Pembuatan akun memudahkan anda untuk memantau lowongan kerja..<br>
                      Dan anda dapat melalukan pendaftaran lowongan kerja
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                  <div class="col-lg-6 py-2">
                                        <input type="text" placeholder="Nama Lengkap *" class="form-control" name="nama_lengkap"  type="text" autocomplete="off">
                                    </div>

                                    <div class="col-lg-6 py-2">
                                        <input type="text" placeholder="Nama Pangilan *" class="form-control" name="nama_pang"  type="text" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="col-lg-12 pt-2">
                                       <input type="text" class="form-control" placeholder="pencari kerja"   name="akses" readonly="" value="pencari kerja">
                                    </div>

                                    <div class="col-lg-12 pt-2">
                                       <input hidden type="text" class="form-control" placeholder="Aktif"   name="akun" readonly="" value="Aktif">
                                    </div>
                                </div>
                            </div>
