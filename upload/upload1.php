				...
				<div class="row">
							   ...
							   <input type="hidden" name="id_pencari_kerja" value="<? echo "$n[id_pencari_kerja]";?>">
								...
								<div class="form-group">
									<label for="first-name">Jenis Kelmain</label>
									 <input type="text" class="form-control" value="<?php echo $n['jenis_kelamin'];?>" name="jenis_kelamin">
								</div>
								<!-- Zip Code -->
								<div class="form-group">
									<label for="first-name">Alamat</label>
									 <input type="text" class="form-control" value="<?php echo $n['alamat'];?>" name="alamat">
								</div>
								<div class="form-group">
									<label for="first-name">Agama</label>
									 <input type="text" class="form-control" value="<?php echo $n['agama'];?>" name="agama">
								</div>
								<div class="form-group">
									<label for="first-name">Status</label>
									 <input type="text" class="form-control" value="<?php echo $n['status'];?>" name="status">
								</div>
								<div class="form-group">
					...
					<div class="widget change-password">
						<h3 class="widget-header user">Pendidikan dana Pengalaman kerja</h3>
							...
							<div class="form-group">
     					 <label for="exampleInputFile">Uplode Foto Profil anda</label><br>
