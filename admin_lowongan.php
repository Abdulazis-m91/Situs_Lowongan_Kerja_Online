    ...
    <hr>
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Pendaftar Seluruh Lowongan Kerja</h3>
            <table class="table table-bordered">
                ...
                <?php
            $no=1;
            $cari=  mysql_query("SELECT * FROM lowongan")or die ("data kosong");
                  ...
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      <li class="list-inline-item">
                        <a data-toggle="tooltip" data-placement="top" title="Lihat" class="view" href="detail.php?id=<?php echo $tampil['id_lowongan']; ?>" >
                          <i class="fa fa-eye"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a class="delete" data-toggle="tooltip" data-placement="top" title="Hapus" href="hapus_lowongan.php?id=<?php echo $tampil['id_lowongan'];?>
