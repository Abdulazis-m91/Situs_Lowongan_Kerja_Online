    ...
    <div class="row">
        ...
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              ...
              <li><a href="user-profile.php"><i class="fa fa-user"></i>Lihat Profil</a></li>
              <li><a href="home.php"><i class="fa fa-bookmark-o"></i>Cari Lowongan<span></span></a></li>
              <li class="active"><a href="daftar_lamaran.php"><i class="fa fa-file-archive-o"></i>Lamaran Kerja<span></span></a></li>
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Lamaran Kerja yang sudah anda buat</h3>
                  ...
                  <div class="">
                    <ul class="list-inline justify-content-center">
                      <li class="list-inline-item">
                        <a data-toggle="tooltip" data-placement="top" title="Lihat Lowongan" class="view" href="detail.php?id=<?php echo $tampil['id_lowongan']; ?>" >
                          <i class="fa fa-eye"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a class="delete" data-toggle="tooltip" data-placement="top" title="Batalkan" href="hapus_lamaran.php?id=<?php echo $tampil['id_daftar'];?>
