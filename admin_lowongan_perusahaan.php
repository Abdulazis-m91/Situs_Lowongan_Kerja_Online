...
$id=$_GET['id'];
$l = mysql_query("SELECT * from perusahaan where idprusahaan='$id'");
    ...
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
        <div class="sidebar">
          ...
          <div class="col-md-25 col-sm-15 col-xs-5">
             <img src="logo/<? echo "$na[logo]";?>" alt="gambar" class="avatar img-circle img-thumbnail">
            </div>
            <!-- User Name -->
            <h5 class="text-center"><? echo "$na[nama_prusahaan]";?></h5>
          </div>
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        ...
        <div class="widget dashboard-container my-adslist">
          <h3 class="widget-header">Daftar Lowongan Kerja <? echo "$na[nama_perusahaan]";?></h3>
            <table class="table table-bordered">
                ...
                <?php
            $no=1;
            $cari=  mysql_query("SELECT * FROM lowongan WHERE idprusahaan='$na[idprusahaan]'")or die ("data kosong");
